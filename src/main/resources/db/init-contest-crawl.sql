...
CREATE TABLE IF NOT EXISTS contest_source (
    ...
    crawl_cron        VARCHAR(64)  DEFAULT '0 */10 * * * ?' COMMENT 'Quartz cron，默认每10分钟',
...
CREATE TABLE IF NOT EXISTS contest_crawl_log (
    ...
    inserted_count   INT          NOT NULL DEFAULT 0 COMMENT '新增入库条数',
    updated_count    INT          NOT NULL DEFAULT 0 COMMENT '更新条数',
    skipped_count    INT          NOT NULL DEFAULT 0 COMMENT '无变化跳过条数',
    ignored_count    INT          NOT NULL DEFAULT 0 COMMENT '无效数据忽略条数',
