...
CREATE TABLE IF NOT EXISTS notify_task (
    ...
    status           VARCHAR(16)  NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING/PROCESSING/SENT/FAILED/DEAD/CANCELLED',
    sent_at          DATETIME     NULL,
    retry_count      INT          NOT NULL DEFAULT 0,
    error_message    VARCHAR(500) NULL,
    idempotent_key   VARCHAR(128) NOT NULL COMMENT '幂等键',
    created_time     DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    claimed_at       DATETIME     NULL COMMENT '进入 PROCESSING 的时刻，用于崩溃回收',
